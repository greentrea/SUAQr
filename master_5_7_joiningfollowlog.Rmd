...
SUAQ_waypoints_11_20_sf_merger <-
  SUAQ_waypoints_11_20_sf %>% mutate(
    "Time" = manualTime,
    "Focal" = orangutanname,
    "Sex" =.$Sex,
    "Age.Sex"= Class,
...
names(SUAQ_waypoints_11_20_sf_merger)
...
SUAQ_waypoints_11_20_merger <- st_drop_geometry(SUAQ_waypoints_11_20_sf_merger)
SUAQ_waypoints_11all20_sf<- SUAQ_waypoints_11_20_merger %>%  bind_rows(SUAQ_waypoints_17_18)
...
orangutan_followperiods<- waypoints_sfbackup %>%
  ...
  labs(title= "Duration of observation for \n orangutan individuals", x= "date", y="Orangutan name")+
  theme(legend.position = "none") 
orangutan_followperiods

# Histogram of number of gps per individual
specs_orangutan_tot_num_of_gps %>% ggplot(aes(.$Focal))
specs_orangutan_tot_num_of_gps_class<- specs_orangutan_tot_num_of_gps %>% left_join(SUAQ_orangutans[,c(1,2)],by=c("Focal"="Orangutan name"))
