...
plot_BetweenTreeDirectnessxClassFocal<- SUAQ_treedirectness %>% 
  ggplot( aes(x=rr_treedirectness, y=tree_betweentravelled)) +
    scale_fill_viridis(discrete = TRUE, alpha=0.6) +
    geom_jitter(color="blue", size=2, alpha=0.2) +
    geom_jitter(data=SUAQ_randomdirectness,aes(rr_randomdirectness,random_betweentravelled),color="red", size=2, alpha=0.2) +
    theme_ipsum() +
    theme(
...
glm_full <- lmer(rr_treedirectness~ClassFocal+rain_eve+walevel_eve+rain_mo+temp_min_eve+temp_min_mo+avg_temp_tot+fai +(1 | tree_betweennumgps)+ (1 | manualDate),data=SUAQ_treedirectness_stats_naomit)
...
glm_mothers <- lmer(rr_treedirectness~rain_eve+walevel_eve+rain_mo+temp_min_eve+temp_min_mo+avg_temp_tot+fai+ ageFromDOB+ageOfCurrentOffspring+(1 | tree_betweennumgps)+ (1 | manualDate),data=SUAQ_treedirectness_stats_naomit_mother)
