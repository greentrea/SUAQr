...
SUAQ_waypoints_11all20_loc <- read_csv(paste0("data/Processed_data/",str_remove_all(Sys.Date(), "-"),"_SUAQ_waypoints_11all20.csv"),guess_max = min(10000, 30000))
...
SUAQ_locationnetwork_sf_loc <- st_transform(SUAQ_locationnetwork_sf_wgs,crs = 32647)
