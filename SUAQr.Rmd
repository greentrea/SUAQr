...
tmp0<- SUAQ_waypoints_11all20 %>% filter(.$manualDate==as.Date("2013-04-30", tz = "Asia/Pontianak"))
tmp2<- SUAQ_waypoints_11all20 %>% filter(.$fileN=="20140401_FriskaFredyFrankie_Kevin_FN")
tmp3<- SUAQ_followlog %>% filter(.$FocalName=="ibu")
tmp4<- SUAQ_followlog %>% filter(.$Date==as.Date("2013-04-30", tz = "Asia/Pontianak"))
