...
#### Giving a random FN
SUAQ_waypoints_11all20 <- SUAQ_waypoints_11all20 %>% mutate(follow= if_else((follow>1100018),NA_real_,follow))

tmp <- SUAQ_waypoints_11all20 %>% filter(follow>1100018)

SUAQ_waypoints_11all20<- SUAQ_waypoints_11all20 %>% ungroup() %>% 
  group_by(fileN,focal,manualDate,follow) %>% 
...
########################
######################## temp
tmp <- SUAQ_followlog %>% filter(SUAQ_followlog.FollowNumber==720)
