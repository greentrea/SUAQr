...
p1<- SUAQ_waypoints_11all20 %>% ggplot(aes(.$manual_distTolast))+geom_histogram(bins = 1000)+scale_y_log10()
p2<- SUAQ_waypoints_11all20 %>% ggplot(aes(.$manual_distToNext))+geom_histogram(bins = 1000)+scale_y_log10()
