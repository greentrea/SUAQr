...
##### 6.5.2 ClassFocal complement: if ClassFocal is empty/""/unk --> get Class from Orangutan information
...
SUAQ_waypoints_11all20 <-
  ...
  ungroup() %>% rowwise() %>% 
  mutate(ClassFocal = ifelse((is.na(SUAQ_followlog.ClassFocal)|(SUAQ_followlog.ClassFocal== "unk")),
                                  own_valuefinder(
                                          SUAQ_waypoints_11all20,
                                          identification,
                                          "identification",
