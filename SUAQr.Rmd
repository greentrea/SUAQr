...
SUAQ_waypoints_11all20<- SUAQ_waypoints_11all20 %>%  
  mutate(ageOfOffspring1=time_length(difftime(manualDate, SUAQ_orangutans.offspring1_dob), "years"),
         ageOfOffspring2=time_length(difftime(manualDate, SUAQ_orangutans.offspring2_dob), "years"),
         ageOfOffspring3=time_length(difftime(manualDate, SUAQ_orangutans.offspring3_dob), "years")
