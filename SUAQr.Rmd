...
tmp<- SUAQ_waypoints_11all20 %>% filter(focal=="aqra")
tmp0<- SUAQ_waypoints_11all20 %>% filter(.$manualDate==as.Date("2014-04-30", tz = "Asia/Pontianak"))
tmp2<- SUAQ_waypoints_11all20 %>% filter(.$fileN=="20120401_FriskaFredyFrankie_Kevin_FN")
tmp3<- SUAQ_followlog %>% filter(.$FocalName=="aqra")
tmp4<- SUAQ_followlog %>% filter(.$Date==as.Date("2014-05-10", tz = "Asia/Pontianak"))

tmp<- SUAQ_waypoints_11all20 %>% filter(.$follow==1335)
...
tmp0<- SUAQ_waypoints_11_20 %>% filter(.$manualDate==as.Date("2013-03-17", tz = "Asia/Pontianak"))

tmp2<- SUAQ_waypoints_11_20 %>% filter(.$fileN=="20130510_Jebi_UNK_NL")
tmp3<- SUAQ_followlog %>% filter(.$FocalName=="lois")
tmp4<- SUAQ_followlog %>% filter(.$Date==as.Date("2013-03-17", tz = "Asia/Pontianak"))
