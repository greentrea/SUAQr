...
## 3. Combine Datasets 
### 3.1. Merging 2017-2018 data with the rest
##### CRS Code: EPSG 32647
##### Create SF Points
...
## 4. ADDING FOLLOWNUMBER (JOIN) 
### 4.2. Joining 2011-2020 data with followlog and add information to gps file
...
## 5. Adding informative attributes and finishing data frame
### 5.1. Joining orangutans info
...
### 5.2. Create new variables like Sinuosity, DJL, Edge Speed
SUAQ_waypoints_11all20 <- SUAQ_waypoints_11all20 %>% left_join()

### 5.3. Only keep gps points within Bounding box of 330000-360000N / 323000-328000E because some points are wrong probably the N and the E variable are the same (accidently copied)
SUAQ_waypoints_11all20 <- SUAQ_waypoints_11all20 %>% filter(E>323000 & 
                                                            E<328000 & 
                                                            N>330000 & 
                                                            N<360000)

### 5.4. Create project Master-Dataframes
