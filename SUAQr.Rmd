...
SUAQ_waypoints_11all20 <- SUAQ_waypoints_11all20 %>% mutate(automaticTime=if_else((automaticTime%in% c(hms::as_hms("06:31:22")))&(follow==1501),hms::as_hms("11:31:22"),manualTime))
...
SUAQ_waypoints_11all20 <- SUAQ_waypoints_11all20 %>% mutate(automaticTime=if_else((automaticTime%in% c(hms::as_hms("13:09:49")))&(follow==1501),hms::as_hms("18:09:49"),manualTime))
...
SUAQ_waypoints_11all20_loc <- SUAQ_waypoints_11all20_loc %>% mutate(PtType=if_else((manualTime%in% c(hms::as_hms("06:30:00"),hms::as_hms("10:00:00"),hms::as_hms("13:00:00")))&(follow==1780),"abnormal off point",PtType))
