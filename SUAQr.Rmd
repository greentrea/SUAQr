...
SUAQ_waypoints_11_20_male_sf <- st_transform(SUAQ_waypoints_11_20_male_sf,23847)
...
SUAQ_waypoints_11_20_sf <- st_transform(SUAQ_waypoints_11_20,23847)
...
SUAQ_followertracks_11_20<- st_as_sf(SUAQ_followertracks_11_20,
                          crs = 4326)
SUAQ_followertracks_11_20_sf <- st_transform(SUAQ_followertracks_11_20,23847)
...
proj4string(tmp_SUAQ_waypoints_morethan50gps_11all20.sp) <- CRS( "+proj=utm +zone=47 +a=6378160 +b=6356774.50408554 +towgs84=-24,-15,5,0,0,0,0 +units=m +no_defs" )
